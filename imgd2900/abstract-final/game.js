...
const game = {
    ...
    tick: function () {
        ...
        if (game.players.length === game.allyLimit && game.curLevel === game.levels.length - 1) {
            PS.gridShadow(true, colors.yellowOrange);
            PS.alpha(PS.ALL, PS.ALL, 255);
            PS.fade(PS.ALL, PS.ALL, 30);
            PS.scale(PS.ALL, PS.ALL, 100);
            PS.radius(PS.ALL, PS.ALL, 0);
            PS.color(PS.ALL, PS.ALL, colors.yellowOrange);
            PS.borderFade(PS.ALL, PS.ALL, 30);
            PS.borderColor(PS.ALL, PS.ALL, colors.yellowOrange);
            game.players = [];
        }
